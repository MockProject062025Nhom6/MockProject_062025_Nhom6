const PromoSection = () => {
  return (
    <div className="flex-1 bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-full px-12 text-center">
        <div className="mb-12 relative">
          <div className="w-80 h-56 bg-white/20 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/30 p-8 transform rotate-3">
        ...
        <div className="text-white mb-8">
          <h2 className="text-4xl font-bold mb-4 leading-tight">
            Manage all <span className="text-yellow-400">HR Operations</span> from<br />
